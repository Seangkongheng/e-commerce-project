      ...
      <div class="modal-body">
                ...
                <div class="modal-body">
                  <div class="form-group">
                      <label class="form-label text-uppercase" > catagory Name </label>
                      <input type="text" name="catageName" class="form-control" required placeholder="Enter Username">
                  </div>
                  <div class="form-group">
                      <label class="form-label text-uppercase">decription</label>
                      <input type="text" name="categoryDec" class="form-control checking_email"  required placeholder="Decription">
...
<!-- End of Main Content -->
    <div class="card shadow mb-5">
        ...
        <thead>
                ...
                <th scope="col" class="text-uppercase">catagory</th>
                <th scope="col" class="text-uppercase">Descrtiption</th>
        ...
        <?php
              if(mysqli_num_rows($result) > 0)
              {
                while($row=mysqli_fetch_assoc($result))
                {
                 ?> 
                  ...
                  ?>
                  <form action="catagoryEdit" method="POST">
              ...
              <td>
                  <form action="code.php" method="post">
                  <input type="hidden" name="deleteIDcatagory" value=" <?php echo $row['category_id']; ?> ">

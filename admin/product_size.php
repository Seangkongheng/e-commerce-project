      ...
      <div class="modal-body">
                ...
                <div class="modal-body">
                  <div class="form-group">
                      <label class="form-label text-uppercase" > Size name  </label>
                      <input type="text" name="sizeNameadd" class="form-control" required placeholder="Enter your size">
                  </div>
                  <div class="modal-footer">
                     <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                       <button type="submit" name="btnAddsize"class="btn btn-primary">Add</button>
                   </div>
              </div>
        ...
        <?php
              if(mysqli_num_rows($result) > 0)
              {
                while($row=mysqli_fetch_assoc($result))
                {
                 ?> 
                  <tr>
                  <td><?php  echo $row["ProductsizeID"]; ?>  </td>
                  ...
                  ?>
                  <form action="sizeEdite.php" method="POST">
                    <input type="hidden" name="edit_size" value="<?php  echo $row['ProductsizeID']; ?>  ">
                     <button type="submit" name ="btneditsize" class="btn btn-primary text-uppercase"> Edit</button>
                  </form>
                  
              </td>
              <td>
                  <form action="code.php" method="post">
                  <input type="hidden" name="deleteSize" value=" <?php echo $row['ProductsizeID']; ?> ">
                  <button type="sumit" name="btnDeltesize"class="btn btn-danger text-uppercase"> delete</button>
                  </form>
              </td>
            </tr>

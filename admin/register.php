      ...
      <div class="modal-body">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="lastName" class="form-control checking_email" placeholder="Last name">
...
<!--message--->
        ...
        ?>
          ...
          ?>
            <table class="table table-bordered" id="datatableIDadmin" width="100%" cellspacing="0">
              <thead>
                <tr >
                <th>id</th>
                <th>First Name</th>
              ...
              if(mysqli_num_rows($result) > 0)
              {
                ...
                <tr>
                  ...
                  ?>
                      ...
                      <form action="registerEdit.php" method="POST">
                        <input type="hidden" name="edit_Id" value="<?php  echo $row['id']; ?> ">
                         <button type="submit" name ="btnedit" class="btn btn-primary   text-uppercase">Edit</button>
                      </form>
                  ...
                  <td>
                      ...
                      <button type="sumit" name="btndelete"class="btn btn-danger w-100 text-uppercase">delet</button>
                      </form>
                  </td>
                </tr>

...
<!-- End of Main Content -->
    <div class="card shadow mb-5">
      ...
      <div class="date">
      <p>For date  : <?php echo $today?></p>
        <p>Address : Phnome penh</p>
        <p>Addmin : </p>
      </div>
        </div>
        <div class="card-body">
...
<table id="datatableID" class="table table-hover">
  <thead>
  <tr>
         <th scope="col" class="text-uppercase">UserID</th>
         <th scope="col" class="text-uppercase">Fist name</th>
        ...
        <th scope="col" class="text-uppercase">contact</th>
        </tr>
        ...
        <?php
              if(mysqli_num_rows($result) > 0)
              {
                while($row=mysqli_fetch_assoc($result))
                {
                 ?> 
                  <tr>
                  <td><?php  echo $row["user_reg_id"]; ?>  </td>
